...
void displayReglages() {
     ...
     u8g2.setCursor(7, 25);
     u8g2.print("Temperature: "); u8g2.print(temperature, 1);
     u8g2.setCursor(112, 23); u8g2.print("o");
     u8g2.setCursor(25, 35);
     u8g2.print("Batterie: "); u8g2.print(int (batteryPercent)); u8g2.println(" %"); 
     u8g2.setCursor(25, 45);
     u8g2.print("Consigne: "); u8g2.print(consigne, 1);
     u8g2.setCursor(112, 43); u8g2.print("o");
     u8g2.setCursor(0, 60);
     u8g2.print("Mode: ");
     if (fonction == 0) { u8g2.print("OFF"); }
     if (fonction == 1) { u8g2.print("AUTO"); }
     if (fonction == 2) { u8g2.print("ON"); }
     u8g2.setCursor(65, 60);
     u8g2.print("Relais: "); 
     if (relayState == 0) { u8g2.print("OFF"); }
     if (relayState == 1) { u8g2.print("ON"); }
     u8g2.sendBuffer();
...
void setup() {
     ...
     u8g2.drawStr(25, 30, "Initialisation");
     u8g2.sendBuffer();
     ...
     u8g2.setCursor(30, 10);
     u8g2.print(WiFi.localIP());
     u8g2.drawStr(25, 20, "Attente datas!");
     u8g2.sendBuffer();
     delay(1000);
